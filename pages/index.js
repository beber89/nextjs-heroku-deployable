        ...
        <Grid style={styles.fontSerif}>
          ...
          <Grid.Row columns={props.isMobile?1:2} >
            <Grid.Column  style={styles.padding0}>
              ...
              <div style={{position: "absolute", margin: "20px", left: "40px", top: "40px", ...styles.fontSerif, color: "lavender"}}>
                <h2>Cool Products</h2>
            ...
            <Grid.Column  style={styles.padding0}>
              ...
              <div style={{position: "absolute", margin: "20px", left: "40px", top: "40px", ...styles.fontSerif, color: "maroon"}}>
                <h2>Reliable</h2>
